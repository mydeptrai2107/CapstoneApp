...
class PageAppliedAllDay extends StatefulWidget {
  const PageAppliedAllDay({super.key});

  @override
  State<PageAppliedAllDay> createState() => _PageAppliedAllDayState();
}

class _PageAppliedAllDayState extends State<PageAppliedAllDay> {
  List<Apply> list = [];
  ...
  initData() async {
    ...
    list = await Modular.get<ProviderApply>().getListApply(user.userId);
